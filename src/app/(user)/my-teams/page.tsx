    ...
    <div className="max-w-7xl mx-auto py-6 sm:px-6 lg:px-8">
      <div className="px-4 py-6 sm:px-0">
        <div className="flex justify-between items-center mb-6">
          <h1 className="text-2xl font-bold text-black">Mes Équipes</h1>
          <Link
            href="/teams/create"
        ...
        {teams.length === 0 ? (
          <div className="text-center py-12">
            <h3 className="mt-2 text-sm font-medium text-gray-900">Vous n'êtes membre d'aucune équipe</h3>
            <p className="mt-1 text-sm text-gray-500">
              Rejoignez une équipe existante ou créez la vôtre.
            </p>
            <div className="mt-6">
              <Link
                href="/teams"
                    ...
                    <div className="mt-2 flex -space-x-2 overflow-hidden">
                      {team.members.slice(0, 5).map((member) => (
                        <div
                          ...
                          title={`${member.name || member.email}${member.role === 'owner' ? ' (Propriétaire)' : ''}`}
                        >
